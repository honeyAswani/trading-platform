  ...
  return (
    <div className="cotainer">
      <div className="row p-5  mt-5 mb-5">
        <h1 className="fs-3 text-center text-muted" style={{fontWeight:"500"}}>
          We pioneered the discount broking model in India. <br />Now, we are breaking
          ground with our technology.
        </h1>
      </div>
      <div className="row p-5 mt-5 border-top" style={{lineHeight:"1.8",fontSize:"1rem",marginLeft:"10rem",marginRight:"10rem"}}>
